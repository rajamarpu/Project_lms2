...
const CourseDrawer = ({ isOpen, onClose, onSave, courseToEdit, teachers: teacherOptions = [] }) => {
  ...
  // Load teacher options from props; fallback to default static list only
  useEffect(() => {
    setTeachers(teacherOptions.length > 0 ? teacherOptions : DEFAULT_TEACHERS);
  }, [isOpen, teacherOptions]);
