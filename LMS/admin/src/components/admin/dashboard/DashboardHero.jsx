...
const DashboardHero = () => {
  ...
  const summary = useMemo(() => {
    ...
    return {
      newEnrollments: s.totalEnrollments ?? 0,
      coursesPublished: s.totalCourses ?? 0,
      certificatesIssued: s.totalCertificates ?? 0,
                  ...
                  >
                    ...
                    <div>
                      <p className="text-[10px] font-semibold uppercase tracking-wider admin-text-secondary">
                        ...
                        <p className="text-xl font-extrabold admin-text-primary">{loading ? '—' : stat.value}</p>
                    </div>
                  </div>
                );
              })}
