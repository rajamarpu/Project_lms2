...
// data: array of { name, students } from API (monthly stats — new registrations)
const StudentGrowthChart = ({ data, loading }) => {
  const chartData = (data || []).map(d => ({ name: d.name, value: d.students ?? 0 }));
