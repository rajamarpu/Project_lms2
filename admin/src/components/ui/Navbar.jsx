      ...
      <header className="admin-navbar h-16 border-b flex items-center justify-between px-6 sticky top-0 z-40 bg-[var(--admin-nav-bg)] border-[var(--admin-nav-border)] backdrop-blur-lg">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-8 h-8 rounded-lg text-[var(--admin-text-muted)] hover:text-[var(--accent)] hover:bg-[var(--admin-surface-hover)] active:scale-95 focus:outline-none focus:ring-1 focus:ring-[var(--accent)]/40 transition-all flex items-center justify-center"
          >
