        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          {isAuthenticated && user ? (
            ...
            <>
              ...
              <NavLink to="/register/role" className="btn-primary !py-2 !px-4 text-sm">
                Get Started
              </NavLink>
            </>
          )}
          ...
          <div className="container py-4 flex flex-col gap-3">
            ...
            {isAuthenticated && user ? (
              ...
              <>
                ...
                <NavLink to="/register/role" onClick={() => setOpen(false)} className="text-sm py-2 text-primary font-medium">
                  Get Started
                </NavLink>
              </>
            )}
