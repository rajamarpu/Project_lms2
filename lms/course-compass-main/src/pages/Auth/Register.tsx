...
import { Eye, EyeOff, UserPlus, Sparkles, Mail, Lock, User, Clock } from "lucide-react";
...
const Register = () => {
  ...
  const initialRole = requestedRole === "instructor" ? "instructor" : "user";
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">
            {requestedRole === "instructor"
              ? "Create an instructor account to manage courses and engage learners."
              : "Create your free learner account and unlock premium courses."}
          </p>
        </div>
